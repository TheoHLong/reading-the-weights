...
- Config: `configs/cifar_compatibility/cifar10_completion_mps.yaml`
...
- Config: `configs/cifar_compatibility/cifar10_locality4_wd001_50e_mps.yaml`
...
- `width-ablation`
  ...
  - Config direction: compare `d_hidden` values against `configs/cifar_compatibility/cifar10_headline_mps.yaml`
