...
Integration note: the original commands below used flat `configs/*.yaml` paths. In the integrated branch, these Task D configs live under `configs/cifar_compatibility/`.
