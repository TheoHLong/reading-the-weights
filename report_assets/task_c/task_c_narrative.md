...
- `task_c_eigenvector_panel.png`: main compact report panel; MNIST digits `1-5` and Fashion-MNIST classes `trouser`, `pullover`, `dress`, `coat`, `sandal`.
