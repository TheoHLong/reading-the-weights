...
Integration note: the original commands below used flat `configs/*.yaml` paths. In the integrated branch, these CIFAR compatibility configs live under `configs/cifar_compatibility/`.
